    ...
    const config = [
        {
            ...
            uniforms: [{uniform: 'uSpeed', value: 0.4},{uniform: 'uVolatility', value: 0},{uniform: 'uSeed', value: 0.4}],
            animatable: [
        ...
        {
            type: 'LiquidDistortMaterial',
            uniforms: [{uniform: 'uSpeed', value: 0.5},{uniform: 'uVolatility', value: 0},{uniform: 'uSeed', value: 0.1}],
            animatable: [
                {prop: 'uVolatility', from: 0, to: 1}
            ],
            easeFactor: 0.1
        }
    ];
